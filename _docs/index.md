...
1. **Create a List of Books that have Hebraic Content** - Our point of departure was the Logan Library at the Library Company in Philadelphia and Edwin Wolf 2nd's *The Library of James Logan of Philadelphia* (Philadelphia: The Library Company of Philadelphia, 1974). After compiling a list of works to inspect, we visited the Library Company to individual volumes to look for evidence of reading and annotation.
2. **Accessing the catalogues** - as patterns of names, titles and editions began to cluster, we began compiling them in order to check print catalogues and the on-line resource Early American Libraries On-line to see if holdings of these works were listed. With this preliminary searching accomplished, we built a list of authors and titles with Hebraic and/or Oriental studies content and library collections.   colonial library we began using online tools, like Google Books and Hathi Trust to access the catalogues of the various libraries of Colonial America. 
